...
namespace DemoFunction
{
    public static class DemoFunction
    {
            ...
            ILogger log)
        {
            ...
            string result = "";
            Microsoft.AspNetCore.Http.IFormFile file = req.Form.Files[0];
            using (var ms = new MemoryStream())
            {
                ...
                if (file.Length > 0)
                {
                    ...
                    config.Add("access_key", "a9dfdeb1b6cc685f9192c1ddaef1b2f2");
                    config.Add("access_secret", "WoRjUzj3gGPtV2rGHtqMkUx33rGiOfyWR8b3wfl3");
        ...
        class ACRCloudRecognizer
        {
            ...
            private string host = "identify-ap-southeast-1.acrcloud.com";
            private string accessKey = "a9dfdeb1b6cc685f9192c1ddaef1b2f2";
            private string accessSecret = "WoRjUzj3gGPtV2rGHtqMkUx33rGiOfyWR8b3wfl3";
